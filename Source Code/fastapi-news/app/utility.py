...
def generate_summary(news_body):
    client = Groq(api_key="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")
    chat_completion = client.chat.completions.create(
        model="llama-3.3-70b-versatile",
        messages=[
            {
                "role": "system",
                "content": "You are expert in news summarization in english languages. Please summarize the following news article in top 3-5 bullet points in the english language that you get."
            },
            {
                "role": "user",
                "content": news_body
